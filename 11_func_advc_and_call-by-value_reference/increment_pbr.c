 ...
 *
 * File: increment_pbr.c
 * Description: Programm zur Demonstration der Pass-by-reference Thematik 
 ...
 *
 * Hinweis:
 *  Der Wert von `number` in der aufrufenden Funktion wird nun verändert, da Referenzen an die Variable übergeben werden.
 *
 */
