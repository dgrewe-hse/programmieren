 ...
 *
 * File: swap_call-by-value.c
 * Description: Programm zur Demonstration der Call-by-value Thematik 
 ...
 *  werden die neuen Werte nach dem Tausch auf der Konsole ausgegeben. Der Tausch erfolgt jedoch nur innerhalb der Funktion,
 *  da in C Werte standardmäßig per "call by value" übergeben werden. Somit bleiben die ursprünglichen Variablen in der 
 *  aufrufenden Funktion unverändert.
 *
 * Hinweis:
 *  Da die Werte durch "call by value" übergeben werden, beeinflusst diese Funktion nicht die ursprünglichen Werte in der 
 ...
 *  // Die Werte von a und b bleiben in der aufrufenden Funktion unverändert.
 */
